...
const B='20260901-gpx12-1';
const s='H4sIALeYl2oC/5XUPQ6DMAyG4bswE+TfxPY5mIq4/zWa0i6Iofb+KHr1KclxKG5k6CJrww2Gm8q6EFBvYI1hJw7wgPFazvUPxh0o0IIhhRFCNBhzGB8Z3fsPu+sdSzDfMwZf1kDcH1ZDJVcxsQWmsXICe4NruQL+bBzYs1h6cO7kUjOOEAvyLNaZnWuelwgqGCuYKpgrWCq4sIZX1vDAeZ8pi6mEx3xYWcwYMrJY6PsTnG8H37IEkgQAAA==';
...
DATA.latest_upload={file:'export (12).gpx',points_in_file:incoming.length,overlap_timestamps:overlap,new_timestamps_added:incoming.length-overlap,clean_new_fixes:incoming.length-overlap,impossible_removed:0,jitter_smoothed:0,latest_timestamp:incoming[incoming.length-1]?.t||null};
