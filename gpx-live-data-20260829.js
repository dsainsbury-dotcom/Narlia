...
const B='20260829-gpx10-1';
const s='H4sIAGldk2oC/43STQ6DQAgF4Lu4VgMPmB/O4arG+1+j2Nh0UpuU9XzzwiPsu/GKxl11Xnil2pvpPIFQFmoL2kbs2pzKYzrm/7g6urPmcHslY8C1XFYZP6zQYEvnC0t8+8JGLjLidzBMblac+GPPxwuz3YPNBdl6FvWSu4itSRaHBDksjeFWslhqGoes2ZnBzhzhCdzPm8uOERiu3VVSeCh4PAEs51YL/AIAAA==';
...
DATA.points_count=DATA.points=DATA.full_timestamped_points.length;DATA.tracked_days=DATA.days.length;DATA.noise_removed=Number(DATA.noise_removed||0);
DATA.latest_upload={file:'export (10).gpx',points_in_file:incoming.length,overlap_timestamps:overlap,new_timestamps_added:incoming.length-overlap,clean_new_fixes:incoming.length-overlap,latest_timestamp:incoming[incoming.length-1]?.t||null};
